...
from state import State, get_field_options # Import our new helpers

# --- Tool 1: Definition ---
SET_FIELD_TOOL = {
    "function_declarations": [{
        "name": "set_field",
        "description": "Sets a specific field in the state with a new value.",
        "parameters": {
            "type": "OBJECT",
            "properties": {
                "field": {"type": "STRING", "description": "The name of the state field to update."},
...
# We can add more tools here, like SET_HAPPY_TOOL, etc.
ALL_TOOLS = [SET_FIELD_TOOL]
